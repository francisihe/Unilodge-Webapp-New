...
const HomeSection2 = () => {
    return (
        <div className="flex flex-col-reverse lg:my-12 items-center md:grid md:grid-cols-2 lg:max-w-screen-xl lg:mx-auto lg:max-h-screen">
            ...
            <div className='max-h-screen pr-4 lg:pr-10'>
                <img src={hostelImage}
                    alt='Unilodge Hostel Image'
                    className='rounded-lg w-fit pr-4 object-contain' />
            </div>

            <div className='space-y-4 py-10 md:mb-0 md:pr-4 lg:-mt-10 lg:max-w-xl'>
                <div>
                    <h2 className="text-3xl w-[85%] my-5 leading-tight">Built for Students, Landlords, Tenants and Developers</h2>
                ...
                <div>
                    <div className='py-2'>
                        <Link to='/about'><button className='bg-orange-400 py-2 px-3 rounded-md font-medium mr-4 md:mb-2 shadow-lg'>Learn More</button></Link>
                    </div>
                </div>
            </div>
